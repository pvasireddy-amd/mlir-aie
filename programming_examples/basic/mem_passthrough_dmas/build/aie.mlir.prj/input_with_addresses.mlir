module {
  aie.device(npu1_1col) {
    ...
    %in_cons_buff_0 = aie.buffer(%tile_0_1) {address = 16384 : i32, mem_bank = 0 : i32, sym_name = "in_cons_buff_0"} : memref<4096xi32> 
    ...
    memref.global "private" constant @blockwrite_data_2 : memref<8xi32> = dense<[4096, 524288, 0, 0, 0, 0, 0, -2126381248]>
    memref.global "private" constant @blockwrite_data_3 : memref<8xi32> = dense<[4096, 1572864, 0, 0, 0, 0, 0, -2126381247]>
    aiex.runtime_sequence(%arg0: memref<4096xi32>, %arg1: memref<4096xi32>, %arg2: memref<4096xi32>) {
      ...
      %1 = memref.get_global @blockwrite_data_2 : memref<8xi32>
      aiex.npu.blockwrite(%1) {address = 655360 : ui32, column = 0 : i32, row = 1 : i32} : memref<8xi32>
      aiex.npu.write32 {address = 656900 : ui32, column = 0 : i32, row = 1 : i32, value = 0 : ui32}
      %2 = memref.get_global @blockwrite_data_3 : memref<8xi32>
      aiex.npu.blockwrite(%2) {address = 655392 : ui32, column = 0 : i32, row = 1 : i32} : memref<8xi32>
