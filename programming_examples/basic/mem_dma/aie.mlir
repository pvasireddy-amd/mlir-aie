module {
  aie.device(npu1_1col) {
    ...
    %in_cons_buff_0 = aie.buffer(%tile_0_2) {address = 0 : i32, mem_bank = 0 : i32, sym_name = "in_cons_buff_0"} : memref<4096xi32> 
